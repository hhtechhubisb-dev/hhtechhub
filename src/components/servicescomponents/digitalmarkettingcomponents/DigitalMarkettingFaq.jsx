...
const DigitalMarketingFAQ = ({ activeTab, activeIndex, toggleFAQ }) => {
  const currentData = 
    activeTab === "seo" ? seoData :
    activeTab === "social" ? socialMediaData :
    activeTab === "content" ? contentMarketingData :
    activeTab === "email" ? emailMarketingData :
    webDesignData;
