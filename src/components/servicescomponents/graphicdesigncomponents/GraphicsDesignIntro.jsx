    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      <div className="order-2 md:order-1">
        ...
        <p className="text-gray-600 mb-4 leading-relaxed">
          We create purposeful designs that not only look beautiful but also communicate your message effectively and drive meaningful engagement.
        </p>
        <p className="text-gray-600 mb-8 leading-relaxed">
          From brand identities to digital interfaces, our design solutions combine creativity with strategy to deliver measurable results.
        </p>
        <Link to="/get-quote">
...
export default GraphicsDesignIntro;